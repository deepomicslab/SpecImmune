...
# python3 ../scripts/main.py --hg38 //mnt/d/HLAPro_backup/Nanopore_optimize/data/hg38/hg38_no_alt.fa -n HG00731_5 -o /mnt/d/HLAPro_backup/Nanopore_optimize/cyp_results/\
#  -j 15 -y pacbio -i CYP \
# -r /mnt/d/HLAPro_backup/Nanopore_optimize/data/reads_cyp_hpc/HG00731.CYP.fastq.gz 
