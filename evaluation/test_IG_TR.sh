...
python3 ../scripts/main.py --hg38 //mnt/d/HLAPro_backup/Nanopore_optimize/data/hg38/hg38_no_alt.fa -n NA10859 \
 -o /mnt/d/HLAPro_backup/Nanopore_optimize/cyp_results/1KGP\
 -j 15 -y nanopore -i CYP \
-r /mnt/d/HLAPro_backup/Nanopore_optimize/data/CYP2D6/shuai/NA10859.CYP.fastq.gz --align_method_1 minimap2
