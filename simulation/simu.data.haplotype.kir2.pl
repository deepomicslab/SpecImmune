...
my $db_fasta = "../db/KIR/KIR.full.fasta";
my $hap_txt = "./KIR.ref.hap.txt";
my $hap_fa ="KIR.ref.hap.fa";
...
`less $hap_txt |sort -k 3 -n >KIR.ref.hap.sort.txt`;
my @regions;
...
open SEP, ">$outdir/$sample.KIR.sep.fa";
<FA>;
my $ref=<FA>;
close FA;
chomp $ref;
