...
do
    ...
    #### run
    python3 ../scripts/main_test.py -n $sample -o $outdir -j 15 -y pacbio -i CYP -r $outdir/$sample/${sample}.fastq.gz --db ../db/ --mode 3
    ...
    python3 ../evaluation/assess_typing.py -i CYP --true $outdir/$sample/$sample.CYP.hap.alleles.txt --infer $outdir/$sample/${sample}.CYP.type.result.txt 
    break
