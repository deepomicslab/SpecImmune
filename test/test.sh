...
# python ../scripts/select_best_reference_alleleV2.py -r /mnt/d/HLAPro_backup/Nanopore_optimize/data/hifi_fq/HG00514_pacbio.fastq.gz -j 15 -i HLA -n HG00514 -o test --db $db
