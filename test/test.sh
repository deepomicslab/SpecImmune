...
# python ../scripts/long_read_typing.py -r /mnt/d/HLAPro_backup/Nanopore_optimize/data/complex_reads/HG00514.1.hla.extract.fastq.gz -j 15 -i HLA -m 0 -n HG00514_HLA -o test --db $db
