...
#    samtools view -bS -F 0x800 -@ {args["j"]}  /scratch/project/cs_shuaicli/wxd/hla_nano/hla/fq/typing_out_3/{args["n"]}/nano_ori/{args["n"]}/{args["n"]}.db.sam | samtools sort -@ {args["j"]} - >{args["o"]}/{args["n"]}/{args["n"]}.db.bam
...
#    cmd = f"""
#    echo search  {args["o"]}/{args["n"]}/{args["n"]}.db.sam ...
#    samtools view -bS  {args["o"]}/{args["n"]}/{args["n"]}.db.sam | samtools sort - >{args["o"]}/{args["n"]}/{args["n"]}.db.bam
#    samtools depth {args["o"]}/{args["n"]}/{args["n"]}.db.bam>{args["o"]}/{args["n"]}/{args["n"]}.db.depth
#    """
#    os.system(cmd)
#    return """%s/%s/%s.db.depth"""%(args["o"], args["n"], args["n"])
