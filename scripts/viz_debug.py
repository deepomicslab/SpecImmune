...
reference_path = "HLA.allele.1.HFE.fasta"
chrom = "HFE_0"
start = 0
end = 7961
width = 900
...
covtrack = BAMCoverageTrack("HFE.remap2res1.bam", name="bam coverage")
...
bam_track_hg002 = SingleEndBAMTrack("HFE.remap2res1.bam", name="Alignment (reference: DRB1*01:01:01:01)", bam_type="normal")
