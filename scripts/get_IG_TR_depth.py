...
def get_consensus(phased_vcf, focus_gene_list, tmp_dir, args, depth_bed_file, gene_mean_depth_dict, short_cutoff = 50):
    if args['lite'] == 1:
        ...
        interval_dict = bed_db.get_gene_interval(bed_db.gene_file)
    # print (interval_dict)
    # print (args['lite'])
    # sys.exit()
    all_result_dict = {}
...
if __name__ == "__main__":
    ...
    required.add_argument("--lite", type=int, help="if use lite hg38 (segments) 0|1",metavar="\b", default=1)
